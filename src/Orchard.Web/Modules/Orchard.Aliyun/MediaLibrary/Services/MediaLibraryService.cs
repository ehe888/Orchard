...
namespace Orchard.Aliyun.MediaLibrary.Services {
    ...
    public class MediaLibraryService : IMediaLibraryService {
        ...
        public MediaPart ImportMedia(string relativePath, string filename, string contentType) {
            ...
            using (var stream = storageFile.OpenRead()) {
                ...
                var mediaPart = mediaFactory.CreateMedia(stream, _storageProvider.Combine(relativePath, filename), mimeType, contentType);
                if (mediaPart != null) {
        ...
        private static IMediaFolder BuildMediaFolder(IStorageFolder folder) {
            return new Orchard.Aliyun.MediaLirary.Models.MediaFolder {
                Name = folder.GetName(),
